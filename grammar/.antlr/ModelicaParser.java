...
public class ModelicaParser extends Parser {
	...
	public final Element_listContext element_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 24)) & ~0x3f) == 0 && ((1L << (_la - 24)) & -9141831841415655295L) != 0)) {
				{
				{
				setState(189);
				element();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Element_class_definitionContext extends ElementContext {
		public Element_optionsContext element_options() {
			return getRuleContext(Element_optionsContext.class,0);
		}
		...
		public Element_class_definitionContext(ElementContext ctx) { copyFrom(ctx); }
	}
	...
	public final ElementContext element() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new Element_class_definitionContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(197);
				element_options();
	...
	public final Arithmetic_expressionContext arithmetic_expression() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 245760L) != 0)) {
				...
				{
				setState(323);
				((Arithmetic_expressionContext)_localctx)._tset889 = _input.LT(1);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 245760L) != 0)) ) {
					((Arithmetic_expressionContext)_localctx)._tset889 = (Token)_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					_errHandler.reportMatch(this);
				...
				((Arithmetic_expressionContext)_localctx).op.add(((Arithmetic_expressionContext)_localctx)._tset889);
				setState(324);
				term();
				}
				}
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3932160L) != 0)) {
				...
				{
				setState(331);
				((TermContext)_localctx)._tset918 = _input.LT(1);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3932160L) != 0)) ) {
					((TermContext)_localctx)._tset918 = (Token)_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					_errHandler.reportMatch(this);
				...
				((TermContext)_localctx).op.add(((TermContext)_localctx)._tset918);
				setState(332);
				factor();
				}
				}
